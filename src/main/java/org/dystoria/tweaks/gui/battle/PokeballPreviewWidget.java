...
public class PokeballPreviewWidget extends ClickableWidget {
    ...
    private static final Identifier ALIVE_LEFT_ACTIVE = DystoriaTweaksClient.identifier("textures/gui/battle/alive_left_active.png");
    ...
    private static final Identifier ALIVE_RIGHT_ACTIVE = DystoriaTweaksClient.identifier("textures/gui/battle/alive_right_active.png");
    ...
    private static final Identifier STATUS_LEFT_ACTIVE = DystoriaTweaksClient.identifier("textures/gui/battle/status_left_active.png");
    ...
    private static final Identifier STATUS_RIGHT_ACTIVE = DystoriaTweaksClient.identifier("textures/gui/battle/status_right_active.png");
    ...
    private static final Identifier FAINTED_LEFT_ACTIVE = DystoriaTweaksClient.identifier("textures/gui/battle/fainted_left_active.png");
    ...
    private static final Identifier FAINTED_RIGHT_ACTIVE = DystoriaTweaksClient.identifier("textures/gui/battle/fainted_right_active.png");
    ...
    protected void renderWidget (DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (this.isHovered()) {
            ...
            this.underlying.render(
                ...
                (MinecraftClient.getInstance().getWindow().getScaledHeight() - BattlePokemonMemory.PANEL_HEIGHT) / 2,
                delta,
                this.isLeft
            );
        }
        ...
        if (this.underlying.isAlive()) {
            Identifier hpTexture = this.underlying.hasStatus() ? STATUS_HP : ALIVE_HP;
